...
def upgrade() -> None:
    ...
    invoiceitemtype = PgEnum(
        "rent", "electricity", "water", "surcharge", name="invoiceitemtype"
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "contract_id", sa.Integer(), sa.ForeignKey("contract.id"), nullable=False
        ),
        sa.Column("period", sa.String(7), nullable=False),
        sa.Column("total", sa.Numeric(precision=14, scale=0), nullable=False),
        sa.Column(
            "status",
            PgEnum("draft", "sent", "paid", name="invoicestatus", create_type=False),
            nullable=False,
    ...
    op.create_unique_constraint(
        "uq_invoice_contract_period", "invoice", ["contract_id", "period"]
    )
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), primary_key=True),
        sa.Column(
            "invoice_id", sa.Integer(), sa.ForeignKey("invoice.id"), nullable=False
        ),
        sa.Column(
            "item_type",
            PgEnum(

...
PROPERTIES = [
    {
        ...
        "surcharges": [
            {"name": "Phí wifi", "calc_type": SurchargeCalcType.per_room, "amount": Decimal("100000")},
            {"name": "Phí vệ sinh", "calc_type": SurchargeCalcType.per_person, "amount": Decimal("20000")},
        ],
        "rooms": [
            {"room_number": "101", "floor": 1, "area_m2": Decimal("22"), "rent_price": Decimal("3500000"), "deposit": Decimal("7000000")},
            {"room_number": "102", "floor": 1, "area_m2": Decimal("18"), "rent_price": Decimal("3000000"), "deposit": Decimal("6000000")},
            {"room_number": "201", "floor": 2, "area_m2": Decimal("25"), "rent_price": Decimal("4000000"), "deposit": Decimal("8000000"), "elec_rate": Decimal("4000")},
            {"room_number": "202", "floor": 2, "area_m2": Decimal("20"), "rent_price": Decimal("3500000"), "deposit": Decimal("7000000")},
            {"room_number": "301", "floor": 3, "area_m2": Decimal("30"), "rent_price": Decimal("5000000"), "deposit": Decimal("10000000")},
        ],
    },
    {
        ...
        "surcharges": [
            {"name": "Phí rác", "calc_type": SurchargeCalcType.per_room, "amount": Decimal("30000")},
        ],
        "rooms": [
            {"room_number": "A1", "floor": 1, "area_m2": Decimal("20"), "rent_price": Decimal("2800000"), "deposit": Decimal("5600000")},
            {"room_number": "A2", "floor": 1, "area_m2": Decimal("20"), "rent_price": Decimal("2800000"), "deposit": Decimal("5600000")},
            {"room_number": "B1", "floor": 2, "area_m2": Decimal("22"), "rent_price": Decimal("3200000"), "deposit": Decimal("6400000")},
            {"room_number": "B2", "floor": 2, "area_m2": Decimal("22"), "rent_price": Decimal("3200000"), "deposit": Decimal("6400000")},
            {"room_number": "C1", "floor": 3, "area_m2": Decimal("28"), "rent_price": Decimal("3800000"), "deposit": Decimal("7600000")},
        ],
    },
]
    ...
    async with async_session() as session:
        ...
        for prop_data in PROPERTIES:
            ...
            for room_data in rooms_data:
                room = Room(**room_data, property_id=prop.id, status=RoomStatus.occupied)
                session.add(room)
                await session.flush()
...
def main() -> None:
    ...
    parser.add_argument("--user-id", required=True, help="Clerk user_id (e.g. user_2abc...)")

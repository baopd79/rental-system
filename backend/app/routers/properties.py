...
async def create_property(body: PropertyCreate, clerk_user_id: CurrentUserDep, service: PropertyServiceDep):
    return await service.create_property(body, clerk_user_id)


@router.get("/{property_id}", response_model=PropertyRead)
async def get_property(property_id: int, clerk_user_id: CurrentUserDep, service: PropertyServiceDep):
...
async def delete_property(property_id: int, clerk_user_id: CurrentUserDep, service: PropertyServiceDep):

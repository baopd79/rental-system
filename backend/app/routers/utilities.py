...
@router.get("/rooms/{room_id}/utility-readings", response_model=list[UtilityReadingRead])
async def list_readings(room_id: int, clerk_user_id: CurrentUserDep, service: UtilityServiceDep):
...
async def create_reading(body: UtilityReadingCreate, clerk_user_id: CurrentUserDep, service: UtilityServiceDep):
...
async def update_reading(reading_id: int, body: UtilityReadingUpdate, clerk_user_id: CurrentUserDep, service: UtilityServiceDep):
...
async def delete_reading(reading_id: int, clerk_user_id: CurrentUserDep, service: UtilityServiceDep):

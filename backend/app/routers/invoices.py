...
async def list_room_invoices(
    room_id: int, clerk_user_id: CurrentUserDep, service: InvoiceServiceDep
):
...
async def list_invoices(
    contract_id: int, clerk_user_id: CurrentUserDep, service: InvoiceServiceDep
):
...
async def get_invoice(
    invoice_id: int, clerk_user_id: CurrentUserDep, service: InvoiceServiceDep
):
...
@router.post(
    "/invoices/public/{token}/report-payment", response_model=InvoicePublicRead
)

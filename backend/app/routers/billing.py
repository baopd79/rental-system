...
@router.get(
    "/properties/{property_id}/billing/status", response_model=list[RoomBillingStatus]
)
...
@router.get(
    "/properties/{property_id}/billing/invoice-preview",
    response_model=list[InvoicePreviewRow],
)
...
@router.post(
    "/properties/{property_id}/billing/readings", response_model=list[RoomBillingStatus]
)
...
@router.post(
    "/properties/{property_id}/billing/invoices", response_model=BatchInvoiceResult
)
